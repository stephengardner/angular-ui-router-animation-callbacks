 ...
 * })
	 ...
	 * </pre>
	 */
	$ViewDirective.$inject = ['$state', '$injector', '$uiViewScroll', '$rootScope'];
	function $ViewDirective($state,   $injector,   $uiViewScroll, $rootScope) {
					...
					function cleanupLastView() {
						...
						if (currentEl) {
							renderer.leave(currentEl, function() {
								$rootScope.$broadcast("animationEnd", $state);
								previousEl = null;
							});
					...
					function updateView(firstTime) {
						...
						var clone = $transclude(newScope, function(clone) {
							renderer.enter(clone, $element, function onUiViewEnter() {
								$rootScope.$broadcast("animationStart", $state);
